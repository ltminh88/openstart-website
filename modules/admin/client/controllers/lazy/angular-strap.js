 ...
 */
  ...
  angular.module('core.admin').controller('AlertDemoCtrl', function($scope, $templateCache, $timeout, $alert) {
  ...
  angular.module('core.admin').controller('AsideDemoCtrl', function($scope) {
    $scope.aside = {title: 'Title', content: 'Hello Aside<br />This is a multiline message!'};
  });

  angular.module('core.admin').controller('ButtonDemoCtrl', function($scope) {
    $scope.button = {
      toggle: false,
  ...
  angular.module('core.admin').controller('DropdownDemoCtrl', function($scope, $alert) {
    $scope.dropdown = [
  ...
  angular.module('core.admin').controller('CollapseDemoCtrl', function($scope, $templateCache) {
    $scope.panels = [
  ...
  angular.module('core.admin').controller('DatepickerDemoCtrl', function($scope, $http) {
  ...
  angular.module('core.admin').controller('TimepickerDemoCtrl', function($scope, $http) {
  ...
  angular.module('core.admin').controller('ModalDemoCtrl', function($scope, $modal) {
  ...
  angular.module('core.admin').controller('SelectDemoCtrl', function($scope, $http) {
  ...
  angular.module('core.admin').controller('TabDemoCtrl', function($scope, $templateCache) {
  ...
  angular.module('core.admin').controller('TooltipDemoCtrl', function($scope, $q, $sce, $tooltip) {
  ...
  angular.module('core.admin').controller('PopoverDemoCtrl', function($scope) {
  ...
  angular.module('core.admin').controller('TypeaheadDemoCtrl', function($scope, $templateCache, $http) {
