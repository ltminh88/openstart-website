...
exports.update = function (req, res) {
  ...
  project.lyrics = req.body.lyrics;
  project.lyricsproject = req.body.lyricsproject;
  project.subtitle = req.body.subtitle;
  project.urllink = req.body.urllink;
  project.urlmp3 = req.body.urlmp3;
  project.urlmp4 = req.body.urlmp4;
  //Images
  project.thumbnail = req.body.thumbnail;
  project.slideshow = req.body.slideshow;
  project.projectlanguage = req.body.projectlanguage;
